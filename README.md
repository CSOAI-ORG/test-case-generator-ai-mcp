<!-- mcp-name: io.github.CSOAI-ORG/test-case-generator-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/test-case-generator-ai-mcp.html)
...
[![PyPI](https://img.shields.io/pypi/v/test-case-generator-ai-mcp)](https://pypi.org/project/test-case-generator-ai-mcp/) [![Python](https://img.shields.io/pypi/pyversions/test-case-generator-ai-mcp)](https://pypi.org/project/test-case-generator-ai-mcp/)
...
```json
{
  "mcpServers": {
    "test-case-generator-ai-mcp": {
      "command": "uvx",
      "args": ["test-case-generator-ai-mcp"]
    }
  }
}
```

Or: `pip install test-case-generator-ai-mcp` then run the `test-case-generator-ai-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `generate_test_cases` to …"
- "Use `generate_edge_cases` to …"
- "Use `generate_test_matrix` to …"
